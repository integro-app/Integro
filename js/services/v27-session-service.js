(function (global) {
  ...
  async function callable(name, payload = {}) {
    ...
    if (!global.firebase?.functions) throw new Error("Firebase Functions indisponível.");
    return (await global.firebase.functions("southamerica-east1").httpsCallable(name)(payload)).data || {};
  }
