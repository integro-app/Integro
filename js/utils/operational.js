...
(function () {
  ...
  function detectarCargoCliente(usuario = {}, tipoNormalizado = "") {
    ...
    if (candidatos.some(v => v.includes("administrativ") || v === "adm")) return "administrativo";
    if (candidatos.some(v => v.includes("captador") || v.includes("captacao") || v === "leads" || v.includes("gestor_de_leads"))) return "captador";
  ...
  function normalizarAcessoUsuario(usuario = {}) {
    ...
    return {
      ...
      isAdministrativo: tipoUsuarioOficial === "usuario_cliente" && cargoChave === "administrativo",
  ...
  function usuarioAtendePerfil(usuario = {}, perfilObrigatorio = "") {
    ...
    if (["gerente", "administrativo", "captador", "supervisor", "vendedor", "financeiro", "auditor"].includes(obrigatorio)) {
